// learn Store method in different object 
...
// Improve code Using Object.create 
// __proto__ is a reference of object 
// for example
const userMethos = {
    about: function () {
        return `${this.firstName} ${this.lastName} is ${this.age} years old.`
...
function createUser(firstName, lastName, email, age, address) {
    const user = Object.create(userMethos); // give empty object {} and chain get
    user.firstName = firstName;
    user.lastName = lastName;
    user.email = email;
    user.age = age;
